...
public class demoData {
    ...
    Flight healthMapping = Flight.newFlight()
            ...
            .value(demoData::getAppointmentSequenceID).ok()
            .addProperty("date.UpcomingVisit")
            .value(demoData::safeupcomingApptParse).ok()
            .addProperty("date.MissedAppointment")
            .value(demoData::safemissedApptParse).ok()
            ...
            .value(demoData::getAdmissionSequenceID).ok()
            ...
            .ok()
            .addProperty("general.AppointmentSequenceID")
            .value(demoData::getAppointmentSequenceID)
            .ok()
            .endAssociation()
            ...
            .ok()
            .addProperty("general.AdmissionSequenceID")
            .value(demoData::getAdmissionSequenceID)
            .ok()
            .endAssociation()
            ...
            .ok()
            .addProperty("general.AssessmentSequenceID")
            .value(demoData::getAssessmentSequenceID)
            .ok()
            .endAssociation()
            .endAssociations()
            .done();
