...
public class Dispatch {
    ...
    Flight dispatchMapping = Flight
            ...
            .value( row -> dateHelper0.parse( row.getAs( "CFS_DateTimeJanet" ) ).substring( 12, 19 ) ).ok()
            ...
            .to("Place")
            .useCurrentSync()
            .addProperty("place.uniqueID", "Dis_ID")
        ...
        Flight personMapping = Flight
                ...
                .useCurrentSync()
                .addProperty("contact.uniqueID", "ID")
                .addProperty( "contact.PhoneNumber", "CellPhone" )
                .endEntity()
                .addEntity("Place")
                .to("Place")
                .useCurrentSync()
                .addProperty("place.uniqueID", "ID")
                .addProperty( "general.FullName" )
                ...
                .to("DispatchType")
                .useCurrentSync()
                .addProperty("general.dispatchID", "ID")
