        ...
        Flight healthMapping = Flight
                .newFlight()
                    .createEntities()
                        ...
                        .endEntity()
                        .addEntity("DetoxScreening")
                            .to("DetoxScreening")
                            .addProperty("detox.ScreeningID", "id")
                    ...
                    .createAssociations()
                        .addAssociation("Has")
                            ...
                            .fromEntity("Patients")
                            .toEntity("Insurance")
                            .addProperty("general.stringid", "visitDate")
                        .endAssociation()
                        .addAssociation("Used")
                        ...
                        .addAssociation("Taking")
                            ...
                            .addProperty("general.stringid", "visitDate")
                        .endAssociation()
                        .addAssociation("Screened")
                            .ofType("general.Screened").to("Screened")
                            .fromEntity("Patients")
                            .toEntity("DetoxScreening")
                            .addProperty("general.stringid", "visitDate")
                        .endAssociation()
                        ...
                        .addAssociation("AssessedBy")
                            ...
                            .addProperty("general.stringid", "visitDate")
                        .endAssociation()
                        .addAssociation("ScreenedBy")
                            .ofType("general.ScreenedBy").to("ScreenedBy")
                            .fromEntity("DetoxScreening")
                            .toEntity("Providers")
                            .addProperty("general.stringid", "visitDate")
                        .endAssociation()
                    .endAssociations()
