            ...
            .newFlight()
                .createEntities()
                    .addEntity( DISPATCHES_ES_ALIAS )
                        ...
                        // .addProperty( IS_CS_CLEARED_FQN ).value( row -> getString( row.getAs( "IsCallStackCleared" ) ) ).ok()
                        // .addProperty( IS_CS_CAUTION_FQN ).value( row -> getString( row.getAs( "IsCallStackCaution" ) ) ).ok()
                        // .addProperty( IS_CS_ATTENTION_FQN ).value( row -> getString( row.getAs( "IsCallStackAttention" ) ) ).ok()
